...
const partsData = [
    { id: 1, name: "Engine Oil 10W-40 (1L)", sku: "OIL-10W40-1L", brand: "Motul", category: "Fluids", stock: 48, price: 180.00 },
    { id: 2, name: "Oil Filter — Honda PCX", sku: "FLT-OIL-PCX", brand: "Honda Genuine", category: "Filters", stock: 22, price: 95.00 },
    { id: 3, name: "Spark Plug CR8E", sku: "SPK-CR8E", brand: "NGK", category: "Ignition", stock: 64, price: 75.00 },
    { id: 4, name: "Air Filter — Yamaha NMAX", sku: "FLT-AIR-NMAX", brand: "Yamaha Genuine", category: "Filters", stock: 18, price: 220.00 },
    { id: 5, name: "Brake Pad Set — Front", sku: "BRK-PAD-FR", brand: "EBC", category: "Brakes", stock: 30, price: 450.00 },
    { id: 6, name: "Brake Fluid DOT4 (500ml)", sku: "FLD-DOT4-500", brand: "Brembo", category: "Fluids", stock: 25, price: 130.00 },
    { id: 7, name: "Chain Kit 428 (110L)", sku: "CHN-428-110", brand: "DID", category: "Drivetrain", stock: 12, price: 680.00 },
    { id: 8, name: "Front Sprocket 15T", sku: "SPR-FR-15T", brand: "Renthal", category: "Drivetrain", stock: 20, price: 240.00 },
    { id: 9, name: "Rear Sprocket 42T", sku: "SPR-RR-42T", brand: "Renthal", category: "Drivetrain", stock: 15, price: 380.00 },
    { id: 10, name: "Fork Oil 15W (1L)", sku: "OIL-FRK-15W", brand: "Motul", category: "Fluids", stock: 16, price: 210.00 },
    { id: 11, name: "Carburetor Jet Kit", sku: "CARB-JET-UNI", brand: "Universal", category: "Engine", stock: 8, price: 350.00 },
    { id: 12, name: "Battery 12V 5Ah", sku: "BAT-12V-5Ah", brand: "Yuasa", category: "Electrical", stock: 10, price: 850.00 },
    { id: 13, name: "Iridium Spark Plug IX", sku: "SPK-IRIDIUM", brand: "NGK", category: "Ignition", stock: 40, price: 320.00 },
    { id: 14, name: "Clutch Lining Set", sku: "CLT-SET-ADV", brand: "FCC", category: "Engine", stock: 14, price: 950.00 },
    { id: 15, name: "Radiator Coolant (1L)", sku: "CLNT-PRE-1L", brand: "Prestone", category: "Fluids", stock: 35, price: 190.00 },
    { id: 16, name: "Handlebar Grips", sku: "GRP-PRO-TAPER", brand: "Pro Taper", category: "Accessories", stock: 25, price: 280.00 },
    { id: 17, name: "LED Headlight Bulb H4", sku: "LED-H4-PHL", brand: "Philips", category: "Electrical", stock: 19, price: 550.00 },
    { id: 18, name: "Tubeless Tire 90/90-14", sku: "TRE-9090-14", brand: "FDR", category: "Tires", stock: 11, price: 1250.00 },
    { id: 19, name: "Braided Brake Hose", sku: "HOSE-BRK-UNI", brand: "Earl's", category: "Brakes", stock: 16, price: 720.00 },
    { id: 20, name: "Exhaust Gasket Ring", sku: "GSK-EXH-UNI", brand: "Universal", category: "Engine", stock: 50, price: 45.00 }
];
...
export function initPartsShop() {
    ...
    function renderTable() {
        ...
        filtered.forEach(item => {
            const currentSource = selectedCart[item.id] ? selectedCart[item.id].source : 'buy';
